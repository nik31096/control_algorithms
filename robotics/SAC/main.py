...
from robotics.SAC.utils import ExperienceReplay, DistanceLogging, HindsightExperienceReplay
...
def main(mode):
    ...
    tau = 5e-3
    batch_size = 512
    writer_name = "./runs/run_8"
    distance_writer_name = "run_8"
    ...
    if mode == 'multi_env':
        ...
        n_envs = 8
        replay_buffer = HindsightExperienceReplay(size=1000000, n_envs=n_envs)
